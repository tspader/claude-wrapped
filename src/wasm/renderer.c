...
static f32 light_dir[3] = {0.577f, 0.577f, -0.577f};
...
static f32 out_fg[MAX_RAYS * 4];
static f32 out_bg[MAX_RAYS * 4];

static u32 upscaled_char[MAX_RAYS];
static f32 upscaled_fg[MAX_RAYS * 4];

static f32 bg_color[3];

static u8 shape_types[MAX_SHAPES];
static f32 shape_params[MAX_SHAPES * 4];
static f32 shape_positions[MAX_SHAPES * 3];
static f32 shape_colors[MAX_SHAPES * 3];
static u8 shape_groups[MAX_SHAPES];
...
static u8 group_blend_mode[MAX_GROUPS];
static u32 group_count = 0;

static v128_t shape_cx[MAX_SHAPES];
static v128_t shape_cy[MAX_SHAPES];
static v128_t shape_cz[MAX_SHAPES];
static v128_t shape_p0[MAX_SHAPES];
static v128_t shape_p1[MAX_SHAPES];
static v128_t shape_p2[MAX_SHAPES];
static v128_t shape_r[MAX_SHAPES];
static v128_t shape_g[MAX_SHAPES];
static v128_t shape_b[MAX_SHAPES];
...
static v128_t sdf_sphere(v128_t px, v128_t py, v128_t pz, v128_t cx, v128_t cy, v128_t cz, v128_t r);
...
static void get_hit_colors_simd(v128_t px, v128_t py, v128_t pz, i32* hit_mask, f32* out_cr, f32* out_cg, f32* out_cb);
...
// =============================================================================
// SDF Primitives (SIMD) Implementation
// =============================================================================
